...
def download_nasa_epic_photo(folderpath, nasa_api_key, count_download_photo):
...
if __name__ == '__main__':
    ...
    count_download_photo = os.getenv('COUNT_NASA_EPIC_PHOTOS', 5)

    download_nasa_epic_photo(folderpath, nasa_api_key, count_download_photo)
